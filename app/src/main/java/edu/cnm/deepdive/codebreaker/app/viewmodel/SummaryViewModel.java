...
public class SummaryViewModel extends ViewModel {
  ...
  SummaryViewModel(@ApplicationContext Context context, GameSummaryRepository repository) {
    ...
    poolSize = new MutableLiveData<>(); //FIXME: Take initial values from prefs and/or resources
    codeLength = new MutableLiveData<>(); //FIXME: Take initial values from prefs and/or resources
